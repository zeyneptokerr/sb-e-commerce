...
const Contact = () => {
    return(
        <div
            ...
            style={{backgroundImage: "url('https://images.pexels.com/photos/8284724/pexels-photo-8284724.jpeg')"}}>
                ...
                <div className="mt-8 text-center">
                    ...
                    <div className="flex flex-col items-center space-y-2 mt-4">
                        ...
                        <div className="flex items-center">
                            ...
                            <span className="text-gray-600">test@gmail.com</span>
                        </div>

                        <div className="flex items-center">
                            <FaMapMarkedAlt className="text-blue-500 mr-2"/>
                            <span className="text-gray-600">8 August, İstanbul, Türkiye</span>
                        </div>
                    </div>
                </div>
            </div>
